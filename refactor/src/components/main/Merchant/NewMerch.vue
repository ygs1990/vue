<template>
  <div class="content">
    <el-form :model="insMchnt" :rules="formRules" ref="mchnt" label-width="120px" >
        ...
        <el-row>
          <el-col :sm="23" :md="{span: 10, offset: 1}">
            <el-form-item label="通道机构：" prop="insId">
              <el-select v-model.trim="insMchnt.insId" filterable clearable @change="getFeeTemplate" placeholder="请选择" style="width: 100%">
                <el-option v-for="(ins, index) in insList" :label="ins.name +'--'+ ins.code" :value="ins.id | stringNumber" :key="ins.id"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          ...
          <el-col :sm="23" :md="{span: 10, offset: 2}">
            <el-form-item label="商户编号：" prop="code">
              <el-input v-model.trim="insMchnt.code" placeholder="必填" @blur="checkDuplicate"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :sm="23" :md="{span: 10, offset: 1}">
            <el-form-item label="商户名称：" prop="name">
              <el-input v-model.trim="insMchnt.name" placeholder="必填"></el-input>
            </el-form-item>
          </el-col>

          <el-col :sm="23" :md="{span: 10, offset: 2}">
            <el-form-item label="商户简称：" prop="shortName">
              <el-input v-model.trim="insMchnt.shortName" placeholder="必填"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :sm="23" :md="{span: 10, offset: 1}">
            <el-form-item label="商户所在地：" prop="districtId">
              <el-row>
                <el-col :span="8">
                  <el-select v-model.trim="insMchnt.provinceId" filterable clearable @change="provinceChange" placeholder="请选择省份">
                ...
                <el-col :span="8">
                  <el-select v-model.trim="insMchnt.cityId" filterable clearable @change="cityChange" placeholder="请选择城市">
                    <el-option v-for="(city, index) in cityList" :label="city.name" :value="city.id | stringNumber" :key="city.id"></el-option>
                  </el-select>
                </el-col>

                <el-col :span="8">
                  <el-select v-model.trim="insMchnt.districtId" filterable clearable placeholder="请选择区县">
          ...
          <el-col :sm="23" :md="{span: 10, offset: 2}">
            <el-form-item label="详细地址：" prop="address">
              <el-input v-model.trim="insMchnt.address"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :sm="23" :md="{span: 10, offset: 1}">
            <el-form-item label="结算户名：" prop="accountName">
              <el-input v-model.trim="insMchnt.accountName"></el-input>
            </el-form-item>
          </el-col>

          <el-col :sm="23" :md="{span: 10, offset: 2}">
            <el-form-item label="结算账号：" prop="account">
              <el-input v-model.trim="insMchnt.account"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :sm="23" :md="{span: 10, offset: 1}">
            <el-form-item label="商户类别：" prop="mccTypeId">
              <el-select v-model.trim="insMchnt.mccTypeId" filterable clearable placeholder="请选择" style="width: 100%" @change="mccChange">
          ...
          <el-col :sm="23" :md="{span: 10, offset: 2}">
            <el-form-item label="商户MCC：" prop="mccCode">
              <el-select v-model.trim="insMchnt.mccCode" filterable clearable placeholder="请选择" style="width: 100%">
        ...
        <el-row>
          <el-col :sm="23" :md="{span: 10, offset: 1}">
            <el-form-item label="专属商户：">
              <el-select v-model.trim="insMchnt.mchntId" filterable clearable placeholder="请选择" style="width: 100%">
          ...
          <el-col :sm="23" :md="{span: 23, offset: 1}">
            <el-form-item label="产品类型：" v-if="mchntTypes.length">
              <el-checkbox-group v-model="checkedTypes">
                <el-checkbox v-for="(type, index) in mchntTypes" :label="type.code" :key="type.code" @change="selectType($event, type.code, index)"></el-checkbox>
              </el-checkbox-group>
            </el-form-item>
          </el-col>
        </el-row>
          ...
          <el-tab-pane v-for="(tab, index) in tabName" :label="tab" :key="tab" :name="tab">
              ...
              <el-row>
                <el-col :sm="24" :md="{span: 11}">
                  <el-form-item label="保底金额(元)：">
                    <el-input v-model.trim="insMchntType.POSP.minimumFeeTemp" placeholder="必填"
                ...
                <el-col :sm="24" :md="{span: 11, offset: 2}">
                  <el-form-item label="末尾取舍：">
                    <el-select v-model="insMchntType.POSP.roundingMode" placeholder="请选择" style="width: 100%">
            ...
            <div v-show="activeName === 'PAY'">
              <el-row>
                <el-col :sm="24" :md="{span: 11}">
                  <el-form-item label="保底金额(元)：">
                    <el-input v-model.trim="insMchntType.PAY.minimumFeeTemp" placeholder="必填"
                ...
                <el-col :sm="24" :md="{span: 11, offset: 2}">
                  <el-form-item label="末尾取舍：">
                    <el-select v-model="insMchntType.PAY.roundingMode" placeholder="请选择" style="width: 100%">
                      <el-option label="向上取整" value="ROUND_UP"></el-option>
                      <el-option label="向下取整" value="ROUND_DOWN"></el-option>
                      <el-option label="四舍五入" value="ROUND_HALF_UP"></el-option>
                    </el-select>
              ...
              <el-row>
                <el-col :sm="24" :md="{span: 11}">
                  <el-form-item label="终端号：">
                    <el-input v-model.trim="deviceList.PAY.deviceCode" placeholder="必填"
                    ...
                    <el-row :gutter="15"  v-for="(rate, index) in scope.row.rateList" :key="index">
                      ...
                      <el-col :span="11">
                        <el-form-item label="固定手续费(元)：" class="mv5">
                          <el-input v-model.trim="rate.fee" placeholder="必填" @blur="checkFixed(rate.fee, 'PAY', '固定手续费')"></el-input>
                        </el-form-item>
                      </el-col>
            ...
            <div v-show="activeName === 'WECHAT_PAY'">
              <el-row>
                <el-col :sm="24" :md="{span: 11}">
                  <el-form-item label="保底金额(元)：">
                    <el-input v-model.trim="insMchntType.WECHAT_PAY.minimumFeeTemp" placeholder="必填"
                ...
                <el-col :sm="24" :md="{span: 11, offset: 2}">
                  <el-form-item label="末尾取舍：">
                    <el-select v-model="insMchntType.WECHAT_PAY.roundingMode" placeholder="请选择" style="width: 100%">
                      <el-option label="向上取整" value="ROUND_UP"></el-option>
                      <el-option label="向下取整" value="ROUND_DOWN"></el-option>
                      <el-option label="四舍五入" value="ROUND_HALF_UP"></el-option>
                    </el-select>
            ...
            <div v-show="activeName === 'ALI_PAY'">
              <el-row>
                <el-col :sm="24" :md="{span: 11}">
                  <el-form-item label="保底金额(元)：">
                    <el-input v-model.trim="insMchntType.ALI_PAY.minimumFeeTemp" placeholder="必填"
                ...
                <el-col :sm="24" :md="{span: 11, offset: 2}">
                  <el-form-item label="末尾取舍：">
                    <el-select v-model="insMchntType.ALI_PAY.roundingMode" placeholder="请选择" style="width: 100%">
                      <el-option label="向上取整" value="ROUND_UP"></el-option>
                      <el-option label="向下取整" value="ROUND_DOWN"></el-option>
                      <el-option label="四舍五入" value="ROUND_HALF_UP"></el-option>
                    </el-select>
            ...
            <div v-show="activeName === 'VERIFY'">
              <el-row>
                <el-col :sm="24" :md="{span: 11}">
                  <el-form-item label="保底金额(元)：">
                    <el-input v-model.trim="insMchntType.VERIFY.minimumFeeTemp" placeholder="必填"
                ...
                <el-col :sm="24" :md="{span: 11, offset: 2}">
                  <el-form-item label="末尾取舍：">
                    <el-select v-model="insMchntType.VERIFY.roundingMode" placeholder="请选择" style="width: 100%">
                      <el-option label="向上取整" value="ROUND_UP"></el-option>
                      <el-option label="向下取整" value="ROUND_DOWN"></el-option>
                      <el-option label="四舍五入" value="ROUND_HALF_UP"></el-option>
                    </el-select>
              ...
              <el-row>
                <el-col :sm="24" :md="{span: 11}">
                  <el-form-item label="终端号：">
                    <el-input v-model.trim="deviceList.VERIFY.deviceCode" placeholder="必填"
                      ...
                      <el-col :span="9">
                        <el-form-item label="笔数(笔)：" class="mv5" labelWidth="80px">
                          <el-input v-model.trim="rate.amount" class="fee-width"
                                    :placeholder="index === scope.row.rateList.length - 1 ? '' : '必填'"
                                    :disabled="index === scope.row.rateList.length - 1"
                                    @blur="checkFixed(rate.amount, 'VERIFY', '笔数')">>
                          </el-input>
                        </el-form-item>
                      </el-col>
                      ...
                      <el-col :span="11">
                        <el-form-item label="固定手续费(元)：" class="mv5">
                          <el-input v-model.trim="rate.fee" class="fee-width" placeholder="必填"
                                    @blur="checkFixed(rate.fee, 'VERIFY', '固定手续费')"></el-input>
                        </el-form-item>
                      </el-col>
                ...
                <el-table-column label="支持银行" prop="supportBank" align="center" min-width="250">
                  <template scope="scope">
                    <el-select v-model.trim="scope.row.supportBank" multiple filterable
                               ...
                               :disabled="!(scope.row.txCode > '005002')"
            ...
            <div v-show="activeName === 'GATEWAY'">
              <el-row>
                <el-col :sm="24" :md="{span: 11}">
                  <el-form-item label="保底金额(元)：">
                    <el-input v-model.trim="insMchntType.GATEWAY.minimumFeeTemp" placeholder="必填"
                ...
                <el-col :sm="24" :md="{span: 11, offset: 2}">
                  <el-form-item label="末尾取舍：">
                    <el-select v-model="insMchntType.GATEWAY.roundingMode" placeholder="请选择" style="width: 100%">
                      <el-option label="向上取整" value="ROUND_UP"></el-option>
                      <el-option label="向下取整" value="ROUND_DOWN"></el-option>
                      <el-option label="四舍五入" value="ROUND_HALF_UP"></el-option>
                    </el-select>
              ...
              <el-row>
                <el-col :sm="24" :md="{span: 11}">
                  <el-form-item label="终端号：">
                    <el-input v-model.trim="deviceList.GATEWAY.deviceCode" placeholder="必填"
            ...
            <div v-show="activeName === 'COLLECT'">
              <el-row>
                <el-col :sm="24" :md="{span: 11}">
                  <el-form-item label="保底金额(元)：">
                    <el-input v-model.trim="insMchntType.COLLECT.minimumFeeTemp" placeholder="必填"
                ...
                <el-col :sm="24" :md="{span: 11, offset: 2}">
                  <el-form-item label="末尾取舍：">
                    <el-select v-model="insMchntType.COLLECT.roundingMode" placeholder="请选择" style="width: 100%">
                      <el-option label="向上取整" value="ROUND_UP"></el-option>
                      <el-option label="向下取整" value="ROUND_DOWN"></el-option>
                      <el-option label="四舍五入" value="ROUND_HALF_UP"></el-option>
                    </el-select>
      ...
      <el-form-item>
        <el-button type="danger" @click="cancel('mchnt')">取消</el-button>
  ...
  export default {
    ...
    methods: {
        ...
        _this.$nextTick(()=> {
          ...
          // 获取省市区信息
          ApiService.common.region().then(data => {
      ...
      getFeeTemplate() {
    		let _this = this;
    		let postData = {insId: _this.insMchnt.insId * 1};
        _this.$nextTick(()=> {
        	// 清空原有机构产品类型
          _this.mchntTypes = [];
          _this.checkedTypes = [];
          // 清空原有机构费率
          _this.insMchntFee.POSP = [];
          _this.insMchntFee.PAY = [];
          _this.insMchntFee.WECHAT_PAY = [];
          _this.insMchntFee.ALI_PAY = [];
          _this.insMchntFee.VERIFY = [];
          _this.insMchntFee.GATEWAY = [];
          _this.insMchntFee.COLLECT = [];
          // 清空原有机构交易权限
          _this.selectedPerm = [];
          _this.permList = [];

          // 获取通道机构对应的产品类型
          ApiService.insMchnt.insBusinessList(postData).then(data => {
            if(data.code === 0) {
          ...
          // 获取所属通道机构对应的费率
          ApiService.insMchnt.insFeeList(postData).then(data => {
            if(data.code === 0) {
              _this.insFeeTemplate = data.data;
      ...
      checkDuplicate() {
        let _this = this;
        let code = _this.insMchnt.code;
        if(code) {
          let postData = {queryKey: code, source: 3};
        ...
        _this.$refs[formName].validate(valid => {
                        ...
                        for(let j = 0, leng = _this.insMchntFee[key][i].rateList.length; j < leng; j++) {
                          if(leng === 1) {
                            ...
                            if(j < _this.insMchntFee[key][i].rateList.length) {
                              ...
                              /*if(j > 0 && ((_this.insMchntFee[key][i].rateList[j-1].fee * 1) >= (_this.insMchntFee[key][i].rateList[j].fee * 1))) {
                                _this.$message({
                                  type: 'warning',
          ...
          let postData = {
            insMchnt: {
              ...
              mchntId: _this.insMchnt.mchntId
            },
          ...
          if(valid) {
            ApiService.insMchnt.add(postData).then(data => {
              if(data.code === 0) {
                _this.$message({
                  type: 'success',
                  message: '通道商户新增成功！',
