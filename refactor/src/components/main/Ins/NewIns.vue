        ...
        <el-tab-pane v-for="(tab, index) in tabName" :label="tab" :key="tab" :name="tab">
            ...
            <el-row>
              <el-col :sm="24" :md="{span: 11}">
                <el-form-item label="保底金额(元)：">
                  <el-input v-model.trim="insType.POSP.minimumFeeTemp" placeholder="必填"
              ...
              <el-col :sm="24" :md="{span: 11, offset: 2}">
                <el-form-item label="末尾取舍：">
                  <el-select v-model="insType.POSP.roundingMode" placeholder="请选择" style="width: 100%">
          ...
          <div v-show="activeName === 'PAY'">
            <el-row>
              <el-col :sm="24" :md="{span: 11}">
                <el-form-item label="保底金额(元)：">
                  <el-input v-model.trim="insType.PAY.minimumFeeTemp" placeholder="必填"
              ...
              <el-col :sm="24" :md="{span: 11, offset: 2}">
                <el-form-item label="末尾取舍：">
                  <el-select v-model="insType.PAY.roundingMode" placeholder="请选择" style="width: 100%">
                    <el-option label="向上取整" value="ROUND_UP"></el-option>
                    <el-option label="向下取整" value="ROUND_DOWN"></el-option>
                    <el-option label="四舍五入" value="ROUND_HALF_UP"></el-option>
                  </el-select>
          ...
          <div v-show="activeName === 'WECHAT_PAY'">
            <el-row>
              <el-col :sm="24" :md="{span: 11}">
                <el-form-item label="保底金额(元)：">
                  <el-input v-model.trim="insType.WECHAT_PAY.minimumFeeTemp" placeholder="必填"
              ...
              <el-col :sm="24" :md="{span: 11, offset: 2}">
                <el-form-item label="末尾取舍：">
                  <el-select v-model="insType.WECHAT_PAY.roundingMode" placeholder="请选择" style="width: 100%">
                    <el-option label="向上取整" value="ROUND_UP"></el-option>
                    <el-option label="向下取整" value="ROUND_DOWN"></el-option>
                    <el-option label="四舍五入" value="ROUND_HALF_UP"></el-option>
                  </el-select>
          ...
          <div v-show="activeName === 'ALI_PAY'">
            <el-row>
              <el-col :sm="24" :md="{span: 11}">
                <el-form-item label="保底金额(元)：">
                  <el-input v-model.trim="insType.ALI_PAY.minimumFeeTemp" placeholder="必填"
              ...
              <el-col :sm="24" :md="{span: 11, offset: 2}">
                <el-form-item label="末尾取舍：">
                  <el-select v-model="insType.ALI_PAY.roundingMode" placeholder="请选择" style="width: 100%">
                    <el-option label="向上取整" value="ROUND_UP"></el-option>
                    <el-option label="向下取整" value="ROUND_DOWN"></el-option>
                    <el-option label="四舍五入" value="ROUND_HALF_UP"></el-option>
                  </el-select>
          ...
          <div v-show="activeName === 'VERIFY'">
            <el-row>
              <el-col :sm="24" :md="{span: 11}">
                <el-form-item label="保底金额(元)：">
                  <el-input v-model.trim="insType.VERIFY.minimumFeeTemp" placeholder="必填"
              ...
              <el-col :sm="24" :md="{span: 11, offset: 2}">
                <el-form-item label="末尾取舍：">
                  <el-select v-model="insType.VERIFY.roundingMode" placeholder="请选择" style="width: 100%">
                    <el-option label="向上取整" value="ROUND_UP"></el-option>
                    <el-option label="向下取整" value="ROUND_DOWN"></el-option>
                    <el-option label="四舍五入" value="ROUND_HALF_UP"></el-option>
                  </el-select>
          ...
          <div v-show="activeName === 'GATEWAY'">
            <el-row>
              <el-col :sm="24" :md="{span: 11}">
                <el-form-item label="保底金额(元)：">
                  <el-input v-model.trim="insType.GATEWAY.minimumFeeTemp" placeholder="必填"
              ...
              <el-col :sm="24" :md="{span: 11, offset: 2}">
                <el-form-item label="末尾取舍：">
                  <el-select v-model="insType.GATEWAY.roundingMode" placeholder="请选择" style="width: 100%">
                    <el-option label="向上取整" value="ROUND_UP"></el-option>
                    <el-option label="向下取整" value="ROUND_DOWN"></el-option>
                    <el-option label="四舍五入" value="ROUND_HALF_UP"></el-option>
                  </el-select>
          ...
          <div v-show="activeName === 'COLLECT'">
            <el-row>
              <el-col :sm="24" :md="{span: 11}">
                <el-form-item label="保底金额(元)：">
                  <el-input v-model.trim="insType.COLLECT.minimumFeeTemp" placeholder="必填"
              ...
              <el-col :sm="24" :md="{span: 11, offset: 2}">
                <el-form-item label="末尾取舍：">
                  <el-select v-model="insType.COLLECT.roundingMode" placeholder="请选择" style="width: 100%">
                    <el-option label="向上取整" value="ROUND_UP"></el-option>
                    <el-option label="向下取整" value="ROUND_DOWN"></el-option>
                    <el-option label="四舍五入" value="ROUND_HALF_UP"></el-option>
                  </el-select>
