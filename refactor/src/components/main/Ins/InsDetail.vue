<template>
  <div class="content" v-loading.body.lock="showContent" element-loading-text="拼命加载中...">
      <el-form :model="ins" :rules="formRules" ref="insDetail" label-width="120px">
        <el-row>
          <el-col :sm="23" :md="{span: 10, offset: 1}">
            <el-form-item label="通道机构编号：" prop="code">
              <el-input v-model.trim="ins.code" placeholder="必填" style="width: 100%" readonly>
              </el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :sm="23" :md="{span: 10, offset: 2}">
            <el-form-item label="通道机构名称：" prop="name">
              <el-input v-model.trim="ins.name" placeholder="必填" :readonly="readonly" @blur="checkDuplicate(ins.name)"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :sm="23" :md="{span: 10, offset: 1}">
            <el-form-item label="所属通道：" prop="channelId">
              <el-select v-model.trim="ins.channelId" filterable clearable placeholder="必填" style="width: 100%" :disabled="disabled">
                <el-option v-for="channel in channelList" :label="channel.name" :value="channel.id | stringNumber" :key="channel.id"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
        </el-row>
          ...
          <el-col :sm="23" :md="{span: 23, offset: 1}">
            <el-form-item label="产品类型：">
              <el-checkbox-group v-model="checkedTypes">
                <el-checkbox v-for="(type, index) in businessList" :label="type.code" :key="type.code" @change="selectType($event, type.code, index)" :disabled="disabled"></el-checkbox>
              </el-checkbox-group>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-tabs v-model="activeName" type="border-card" class="mb20" v-if="tabName.length" @tab-click="updateData">
          <el-tab-pane v-for="(tab, index) in tabName" :label="tab" :key="tab" :name="tab">
            ...
            <div v-show="activeName === 'POSP'">
              <el-row>
                <el-col :sm="24" :md="{span: 11}">
                  <el-form-item label="保底金额(元)：">
                    <el-input v-model.trim="insType.POSP.minimumFeeTemp"
                              :readonly="readonly" placeholder="必填"
                              @blur="checkFixed(insType.POSP.minimumFeeTemp, 'POSP', '保底金额')">
                    </el-input>
                  </el-form-item>
                </el-col>
                ...
                <el-col :sm="24" :md="{span: 11, offset: 2}">
                  <el-form-item label="末尾取舍：">
                    <el-select v-model="insType.POSP.roundingMode" placeholder="请选择" style="width: 100%" :disabled="disabled">
              ...
              <el-row>
                <el-col :sm="24" :md="{span: 11}">
                  <el-form-item label="收单银行：">
                    <el-select v-model.trim="ins.bankCode" filterable clearable placeholder="必填" style="width: 100%" :disabled="disabled">
              ...
              <el-table :data="insFee.POSP" border style="width: 100%">
                ...
                <el-table-column label="扣率类型" prop="feeType" align="center">
                  <template scope="scope">
                    <el-select v-model.trim="scope.row.feeType" @change="typeChange(scope.row)" :disabled="disabled">
            ...
            <div v-show="activeName === 'PAY'" style="width: 100%">
              <el-row>
                <el-col :sm="24" :md="{span: 11}">
                  <el-form-item label="保底金额(元)：">
                    <el-input v-model.trim="insType.PAY.minimumFeeTemp"
                              :readonly="readonly" placeholder="必填"
                              @blur="checkFixed(insType.PAY.minimumFeeTemp, 'PAY', '保底金额')">
                    </el-input>
                  </el-form-item>
                </el-col>
                ...
                <el-col :sm="24" :md="{span: 11, offset: 2}">
                  <el-form-item label="末尾取舍：">
                    <el-select v-model="insType.PAY.roundingMode" clearable placeholder="请选择" style="width: 100%" :disabled="disabled">
                      <el-option label="向上取整" value="ROUND_UP"></el-option>
                      <el-option label="向下取整" value="ROUND_DOWN"></el-option>
                      <el-option label="四舍五入" value="ROUND_HALF_UP"></el-option>
                    </el-select>
              ...
              <el-table :data="insFee.PAY" border>
                ...
                <el-table-column label="扣率值" prop="feeFixedTemp" align="center" min-width="550">
                  <template scope="scope">
                    <el-row v-show="scope.row.feeType === '2'">
                    ...
                    <div v-show="scope.row.feeType !== '2'">
                ...
                <el-table-column label="品牌费" prop="brandFeeExp" align="center" width="250">
                  <template scope="scope">
            ...
            <div v-show="activeName === 'WECHAT_PAY'">
              <el-row>
                <el-col :sm="24" :md="{span: 11}">
                  <el-form-item label="保底金额(元)：">
                    <el-input v-model.trim="insType.WECHAT_PAY.minimumFeeTemp"
                              :readonly="readonly" placeholder="必填"
                              @blur="checkFixed(insType.WECHAT_PAY.minimumFeeTemp, 'WECHAT_PAY', '保底金额')">
                    </el-input>
                  </el-form-item>
                </el-col>
                ...
                <el-col :sm="24" :md="{span: 11, offset: 2}">
                  <el-form-item label="末尾取舍：">
                    <el-select v-model="insType.WECHAT_PAY.roundingMode" placeholder="请选择" style="width: 100%" :disabled="disabled">
                      <el-option label="向上取整" value="ROUND_UP"></el-option>
                      <el-option label="向下取整" value="ROUND_DOWN"></el-option>
                      <el-option label="四舍五入" value="ROUND_HALF_UP"></el-option>
                    </el-select>
            ...
            <div v-show="activeName === 'ALI_PAY'">
              <el-row>
                <el-col :sm="24" :md="{span: 11}">
                  <el-form-item label="保底金额(元)：">
                    <el-input v-model.trim="insType.ALI_PAY.minimumFeeTemp"
                              :readonly="readonly" placeholder="必填"
                              @blur="checkFixed(insType.ALI_PAY.minimumFeeTemp, 'ALI_PAY', '保底金额')">
                    </el-input>
                  </el-form-item>
                </el-col>
                ...
                <el-col :sm="24" :md="{span: 11, offset: 2}">
                  <el-form-item label="末尾取舍：">
                    <el-select v-model="insType.ALI_PAY.roundingMode" placeholder="请选择" style="width: 100%" :disabled="disabled">
                      <el-option label="向上取整" value="ROUND_UP"></el-option>
                      <el-option label="向下取整" value="ROUND_DOWN"></el-option>
                      <el-option label="四舍五入" value="ROUND_HALF_UP"></el-option>
                    </el-select>
            ...
            <div v-show="activeName === 'VERIFY'">
              <el-row>
                <el-col :sm="24" :md="{span: 11}">
                  <el-form-item label="保底金额(元)：">
                    <el-input v-model.trim="insType.VERIFY.minimumFeeTemp"
                              :readonly="readonly" placeholder="必填"
                              @blur="checkFixed(insType.VERIFY.minimumFeeTemp, 'VERIFY', '保底金额')">
                    </el-input>
                  </el-form-item>
                </el-col>
                ...
                <el-col :sm="24" :md="{span: 11, offset: 2}">
                  <el-form-item label="末尾取舍：">
                    <el-select v-model="insType.VERIFY.roundingMode" placeholder="请选择" style="width: 100%" :disabled="disabled">
                      <el-option label="向上取整" value="ROUND_UP"></el-option>
                      <el-option label="向下取整" value="ROUND_DOWN"></el-option>
                      <el-option label="四舍五入" value="ROUND_HALF_UP"></el-option>
                    </el-select>
              ...
              <el-table :data="insFee.VERIFY" border style="width: 100%">
                <el-table-column label="交易类型" prop="txCode" align="center" min-width="200">
                  <template scope="scope">
                    <el-input type="hidden" v-model="scope.row.txCode"></el-input>
                    <span>{{scope.row.txName}}</span>
                  </template>
                      ...
                      <el-col :span="9">
                        <el-form-item label="笔数(笔)：" class="mv5" labelWidth="80px">
                          <el-input v-model.trim="rate.amount" class="fee-width"
                                    :placeholder="index === scope.row.rateList.length - 1 ? '' : '必填'"
                                    :disabled="index === scope.row.rateList.length - 1"
                                    :readonly="readonly" @blur="checkAmount(rate.amount, 'VERIFY', '笔数')">
                          </el-input>
                        </el-form-item>
                      </el-col>
            ...
            <div v-show="activeName === 'GATEWAY'">
              <el-row>
                <el-col :sm="24" :md="{span: 11}">
                  <el-form-item label="保底金额(元)：">
                    <el-input v-model.trim="insType.GATEWAY.minimumFeeTemp"
                              :readonly="readonly" placeholder="必填"
                              @blur="checkFixed(insType.GATEWAY.minimumFeeTemp, 'GATEWAY', '保底金额')">
                    </el-input>
                  </el-form-item>
                </el-col>
                ...
                <el-col :sm="24" :md="{span: 11, offset: 2}">
                  <el-form-item label="末尾取舍：">
                    <el-select v-model="insType.GATEWAY.roundingMode" placeholder="请选择" style="width: 100%" :disabled="disabled">
                      <el-option label="向上取整" value="ROUND_UP"></el-option>
                      <el-option label="向下取整" value="ROUND_DOWN"></el-option>
                      <el-option label="四舍五入" value="ROUND_HALF_UP"></el-option>
                    </el-select>
            ...
            <div v-show="activeName === 'COLLECT'">
              <el-row>
                <el-col :sm="24" :md="{span: 11}">
                  <el-form-item label="保底金额(元)：">
                    <el-input v-model.trim="insType.COLLECT.minimumFeeTemp"
                              :readonly="readonly" placeholder="必填"
                              @blur="checkFixed(insType.COLLECT.minimumFeeTemp, 'COLLECT', '保底金额')">
                    </el-input>
                  </el-form-item>
                </el-col>
                ...
                <el-col :sm="24" :md="{span: 11, offset: 2}">
                  <el-form-item label="末尾取舍：">
                    <el-select v-model="insType.COLLECT.roundingMode" placeholder="请选择" style="width: 100%" :disabled="disabled">
                      <el-option label="向上取整" value="ROUND_UP"></el-option>
                      <el-option label="向下取整" value="ROUND_DOWN"></el-option>
                      <el-option label="四舍五入" value="ROUND_HALF_UP"></el-option>
                    </el-select>
        ...
        <el-row>
          <el-col>
            <el-form-item>
              <div>
                <div v-if="showBtn">
                  <el-button type="danger" @click="back('insDetail')">返回</el-button>
                  <el-button type="success" @click="editChannel()">编辑</el-button>
                </div>

                <div v-else>
                  <el-button type="danger" @click="cancel()">取消</el-button>
                  <el-button type="success" @click="submitForm('insDetail')">保存</el-button>
                </div>
              </div>
            </el-form-item>
          </el-col>
    ...
    methods: {
      getInsDetail() {
        ...
        _this.$nextTick(() => {
            // 获取产品类型信息
          let postData = {
          	id: _this.$route.query.insId
          };

          // 获取通道机构详情信息
          ApiService.ins.detail(postData).then(data => {
          	if(data.code === 0) {
              // 通道机构基本信息
              _this.ins = data.data.ins;
              _this.ins.channelId = _this.ins.channelId + '';

              // 通道机构费率
              _this.insFeeTemplate = data.data.insFeeTemplate;
              ...
              for(let i = 0, len = _this.businessList.length; i < len; i++) {
                ...
                // 显示已选中的交易权限
                let txList =  _this.businessList[i].txList;
                for(let j = 0; j < txList.length; j++) {
                  if(txList[j].checkAgent) {
                    _this.selectedPerm.push(txList[j].code);
                  }
                }
              }
              ...
              // 获取各产品类型对应的费率
              for(let i = 0, len = _this.insFeeTemplate.length; i < len; i++) {
                for(let type in _this.insFee) {
                  // 判断产品类型是否想匹配
                  if(_this.insFeeTemplate[i].businessCode === type) {
                    let payBank = [];
                    for(let j = 0, len = _this.insFeeTemplate[i].bankList.length; j < len; j++) {
                      payBank.push(_this.insFeeTemplate[i].bankList[j].code);
                    }

                    // 获取保底金额
                    _this.insType[type].minimumFeeTemp = _this.insFeeTemplate[i].minimumFeeTemp + '';
                    // 获取末尾取舍
                    _this.insType[type].roundingMode = _this.insFeeTemplate[i].roundingMode;
                    ...
                    switch(type) {
                      ...
                      case 'GATEWAY':
                        // 判断扣率类型以组织扣率值
                        if(_this.insFeeTemplate[i].feeType !== 2) {
                          let insFeeList = _this.insFeeTemplate[i].feeFixedTemp.split(';');
                    ...
                    // 插入费率
                    _this.insFee[type].push({
                      txCode: _this.insFeeTemplate[i].txCode,
                      txName: _this.insFeeTemplate[i].txName,
                      cardType: _this.insFeeTemplate[i].cardType,
                      cardTypeName: _this.insFeeTemplate[i].cardTypeName,
                      feeType: _this.insFeeTemplate[i].feeType + '',
                      feeRateTemp: _this.insFeeTemplate[i].feeRateTemp,
                      feeFixedTemp: _this.insFeeTemplate[i].feeFixedTemp,
                      brandFeeExp: _this.insFeeTemplate[i].brandFeeExp,
                      brandRate: _this.insFeeTemplate[i].brandFeeExp.split(',')[0],
                      brandFixed: _this.insFeeTemplate[i].brandFeeExp.split(',')[1],
                      supportBank: payBank,
                      status: _this.insFeeTemplate[i].status + '',
                      rateList: feeList
                    });
                  }
                }
      ...
      checkDuplicate(queryKey) {
        let _this = this;
        if(queryKey) {
          let postData = {queryKey: queryKey, source: 2, operation: '2', code: _this.ins.code};
      ...
      selectType(event, key, index) {
        ...
        if(checked) {
          ...
          // 移除保底金额及末尾取舍
          _this.insType[key].minimumFeeTemp = '';
          _this.insType[key].roundingMode = '';
        }
      },
        ...
        _this.$refs[formName].validate(valid => {
          ...
          for(let key in _this.insFee) {
            for(let i = 0, len = _this.insFee[key].length; i < len; i++) {
              ...
              if(length) {
                // 校验保底金额
                let miniFeeStatus = _this.checkFixed(_this.insType[key].minimumFeeTemp, key, '保底金额');
                if(!miniFeeStatus) {
                  return false;
                }

                // 校验末尾取舍
                if(!_this.insType[key].roundingMode) {
                  _this.$message({
                    type: 'warning',
              ...
              insFeeTemplate.push({
                ...
                roundingMode: _this.insType[key].roundingMode,
                minimumFeeTemp: _this.insType[key].minimumFeeTemp,
          ...
          for(let i = 0, len = _this.selectedPerm.length; i < len; i++) {
            for(let j = 0, leng = _this.businessList.length; j <　leng; j++) {
              for(let k = 0, length = _this.businessList[j].txList.length; k <　length; k++) {
                if(_this.selectedPerm[i] === _this.businessList[j].txList[k].code) {
                  businessList.push({
                    txList: [
                      { code: _this.selectedPerm[i] }
                    ],
                    code: _this.businessList[j].txList[k].businessCode
                  });
                }
              }
            }
          ...
          if(valid) {
            ApiService.ins.update(postData).then(data => {
              if(data.code === 0) {
                _this.$message({
                  type: 'success',
                  message: '通道机构修改成功！',
