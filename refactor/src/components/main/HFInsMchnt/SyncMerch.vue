<template>
  <div class="content">
    <el-form :model="insMchnt" :rules="formRules" ref="mchnt" label-width="150px" >
      ...
      <el-row>
        <el-col :sm="23" :md="{span: 10, offset: 1}">
          <el-form-item label="商户类别：" prop="businessId">
            <el-row>
              <el-col :span="12">
                <el-select v-model.trim="insMchnt.parentMccId" filterable clearable :disabled="disabled"
                           @change="mccChange" placeholder="请选择" style="width: 100%">
                  <el-option v-for="(type, index) in mccType" :label="type.mccName"
                             :value="type.hfMccId | stringNumber" :key="type.hfMccId">
                  </el-option>
                </el-select>
              </el-col>

              <el-col :span="12">
                <el-select v-model.trim="insMchnt.businessId" filterable clearable
                           :disabled="disabled" placeholder="请选择" style="width: 100%">
                  <el-option v-for="(mcc, index) in mccList" :label="mcc.mccName"
                             :value="mcc.mccCode | stringNumber" :key="mcc.hfMccId">
                  </el-option>
                </el-select>
              </el-col>
            </el-row>
        ...
        <el-col :sm="23" :md="{span: 10, offset: 2}">
          <el-form-item label="商户简称：" prop="mchntShortName">
            <el-input v-model.trim="insMchnt.mchntShortName" :readonly="readonly" placeholder="必填"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        <el-col :sm="23" :md="{span: 10, offset: 1}">
          <el-form-item label="区域编码：" prop="regionCode">
            <el-row>
              <el-col :span="8">
                <el-select v-model.trim="insMchnt.proviceRegionId" filterable clearable :disabled="disabled"
              ...
              <el-col :span="8">
                <el-select v-model.trim="insMchnt.cityRegionId" filterable clearable :disabled="disabled"
              ...
              <el-col :span="8">
                <el-select v-model.trim="insMchnt.regionCode" filterable clearable :disabled="disabled" placeholder="请选择区县">
                  <el-option v-for="(region, index) in regionCodes" :label="region.regionName"
                             :value="region.regionCode | stringNumber" :key="region.regionCodeId">
                  </el-option>
                </el-select>
              </el-col>
            </el-row>
      ...
      <el-row>
        ...
        <el-col :sm="23" :md="{span: 10, offset: 2}">
          <el-form-item label="开户城市：" prop="location">
            <el-row>
              <el-col :span="12">
              ...
              <el-col :span="12">
                <el-select v-model.trim="insMchnt.location" filterable clearable
                           :disabled="disabled" placeholder="请选择城市" style="width: 100%">
                  <el-option v-for="(city, index) in cityList" :label="city.name" :value="city.name" :key="city.id"></el-option>
                </el-select>
              </el-col>
            </el-row>
          </el-form-item>
        ...
        <el-col :sm="23" :md="{span: 10, offset: 1}">
          <el-form-item label="身份证正面：" prop="certCorrect">
            <el-upload
              ...
              :file-list="certCorrectList"
              :disabled='disabled || certUnable'>
        ...
        <el-col :sm="23" :md="{span: 10, offset: 2}">
          <el-form-item label="身份证反面：" prop="certOpposite">
            <el-upload
              ...
              :before-upload='checkFile'
              :file-list="certOppositeList"
              :disabled='disabled || certOppUnable'>
              <i class="el-icon-plus"></i>
              <div slot="tip" class="el-upload__tip">只能上传一个jpg/png文件，且不超过2M</div>
            </el-upload>
      ...
      <el-row>
        <el-col :sm="23" :md="{span: 10, offset: 1}">
          <el-form-item label="银行卡正面：" prop="cardCorrect">
            <el-upload
              ...
              :before-upload='checkFile'
              :file-list="cardCorrectList"
              :disabled='disabled || cardUnable'>
              <i class="el-icon-plus"></i>
              <div slot="tip" class="el-upload__tip">只能上传一个jpg/png文件，且不超过2M</div>
            </el-upload>
        ...
        <el-col :sm="23" :md="{span: 10, offset: 2}">
          <el-form-item label="银行卡反面：" prop="cardOpposite">
            <el-upload
              class="upload-demo"
              name="cardOpposite"
              list-type="picture-card"
              ...
              :before-upload='checkFile'
              :file-list="cardOppositeList"
              :disabled='disabled || cardOppUnable'>
              <i class="el-icon-plus"></i>
              <div slot="tip" class="el-upload__tip">只能上传一个jpg/png文件，且不超过2M</div>
            </el-upload>
        ...
        <el-col :sm="23" :md="{span: 10, offset: 1}">
          <el-form-item label="手持身份证：" prop="certMeet">
            <el-upload
              ...
              :before-upload='checkFile'
              :file-list="certMeetList"
              :disabled='disabled || meetUnable'>
              <i class="el-icon-plus"></i>
              <div slot="tip" class="el-upload__tip">只能上传一个jpg/png文件，且不超过2M</div>
            </el-upload>
        ...
        <el-col :sm="23" :md="{span: 10, offset: 1}">
          <el-form-item label="门头照片：" prop="doorImg">
            <el-upload
              ...
              :before-upload='checkFile'
              :file-list="doorImgList"
              :disabled='disabled || doorUnable'>
              <i class="el-icon-plus"></i>
              <div slot="tip" class="el-upload__tip">只能上传一个jpg/png文件，且不超过2M</div>
            </el-upload>
        ...
        <el-col :sm="23" :md="{span: 10, offset: 2}">
          <el-form-item label="收银台照片：" prop="cashierImg">
            <el-upload
              ...
              :before-upload='checkFile'
              :file-list="cashierImgList"
              :disabled='disabled || cashierUnable'>
              <i class="el-icon-plus"></i>
              <div slot="tip" class="el-upload__tip">只能上传一个jpg/png文件，且不超过2M</div>
            </el-upload>
...
<script>
  ...
  export default {
      ...
      return {
        ...
        formRules: {
          ...
          mchntCode: [
            ...
            {pattern: /^1[3|4|5|7|8]\d{9}$/, message: '请输入符合手机号码格式的数字！', trigger: 'blur'}
          ],
          mchntName: [
          ...
          businessId: {required: true, message: '请选择商户MCC！', trigger: 'change'},
          ...
          certCorrect: {required: true, message: '请选择身份证正面照片！', trigger: 'change'},
          certOpposite: {required: true, message: '请选择身份证反面照片！', trigger: 'change'},
          cardCorrect: {required: true, message: '请选择银行卡正面照片！', trigger: 'change'},
          cardOpposite: {required: true, message: '请选择银行卡反面照片！', trigger: 'change'},
          certMeet: {required: true, message: '请选择手持身份证照片！', trigger: 'change'},
          blImg: {required: true, message: '请选择营业执照照片！', trigger: 'change'},
          doorImg: {required: true, message: '请选择门头照片！', trigger: 'change'},
          cashierImg: {required: true, message: '请选择收银台照片！', trigger: 'change'}
        }
      }
    },
    mounted() {
    ...
    computed:{
      ...mapGetters(['getRegion', 'getProvinceCodes', 'getCityCodes', 'getRegionCodes', 'getMccCodes']),
      ...
      ,
      mccType: function (){
        return this.getMccCodes;
      }
    },
    methods: {
      ...mapActions(['getregionCodeList', 'getMccTypes']),
    	getData() {
    		let _this = this;
        ...
        _this.$nextTick(()=> {
          ...
          ApiService.hfInsMchnt.detail(postData).then(data => {
            ...
            _this.insMchnt.businessId = _this.insMchnt.businessId ? _this.insMchnt.businessId + '' : '';
            _this.insMchnt.proviceRegionId = _this.insMchnt.proviceRegionId ? _this.insMchnt.proviceRegionId + '': '';
            _this.insMchnt.cityRegionId = _this.insMchnt.cityRegionId ? _this.insMchnt.cityRegionId + '': '';
            _this.insMchnt.regionCode = _this.insMchnt.regionCode ? _this.insMchnt.regionCode : '';
            ...
            _this.insMchnt.location = _this.insMchnt.location ? _this.insMchnt.location : '';

            // 图片预览
            if(_this.insMchnt.certCorrect !== '' && _this.insMchnt.certCorrect !== null) {
              _this.certCorrectList.push(
                {url: `${ApiService.hfInsMchnt.previewPhotos}?certCorrect=${_this.insMchnt.certCorrect}`}
              );
            }

            if(_this.insMchnt.certOpposite !== '' && _this.insMchnt.certOpposite !== null) {
              _this.certOppositeList.push(
                {url: `${ApiService.hfInsMchnt.previewPhotos}?certOpposite=${_this.insMchnt.certOpposite}`}
              );
            }

            if(_this.insMchnt.certOpposite !== '' && _this.insMchnt.certOpposite !== null) {
              _this.certMeetList.push(
                {url: `${ApiService.hfInsMchnt.previewPhotos}?certMeet=${_this.insMchnt.certMeet}`}
              );
            }

            if(_this.insMchnt.certOpposite !== '' && _this.insMchnt.certOpposite !== null) {
              _this.cardCorrectList.push(
                {url: `${ApiService.hfInsMchnt.previewPhotos}?cardCorrect=${_this.insMchnt.cardCorrect}`}
              );
            }

            if(_this.insMchnt.certOpposite !== '' && _this.insMchnt.certOpposite !== null) {
              _this.cardOppositeList.push(
                {url: `${ApiService.hfInsMchnt.previewPhotos}?cardOpposite=${_this.insMchnt.cardOpposite}`}
              );
            }

            if(_this.insMchnt.certOpposite !== '' && _this.insMchnt.certOpposite !== null) {
              _this.blImgList.push(
                {url: `${ApiService.hfInsMchnt.previewPhotos}?blImg=${_this.insMchnt.blImg}`}
              );
            }

            if(_this.insMchnt.certOpposite !== '' && _this.insMchnt.certOpposite !== null) {
              _this.doorImgList.push(
                {url: `${ApiService.hfInsMchnt.previewPhotos}?doorImg=${_this.insMchnt.doorImg}`}
              );
            }

            if(_this.insMchnt.certOpposite !== '' && _this.insMchnt.certOpposite !== null) {
              _this.cashierImgList.push(
                {url: `${ApiService.hfInsMchnt.previewPhotos}?cashierImg=${_this.insMchnt.cashierImg}`}
              );
            }
      ...
      uploadCardOppsite(file, fileList) {
        this.insMchnt.cardOpposite = file.data;
        this.cardOppUnable = true;
      },
      removeCardOppsite(file){
        this.insMchnt.cardOpposite = '';
      ...
      submitForm(formName) {
        ...
        _this.$refs[formName].validate(valid => {
          // 组织提交数据
          let postData = {
            hfMchntId: _this.insMchnt.hfMchntId,
            ...
            businessId: _this.insMchnt.businessId * 1,
            mchntShortName: _this.insMchnt.mchntShortName,
            ...
            cardOpposite: _this.insMchnt.cardOpposite,
